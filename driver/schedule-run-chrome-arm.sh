...
#        popd
        ...
        pushd /home/user/work/repos/chrome/arm/chromium/src
        git fetch
        ...
        if [ -z "$list" ]; then
            ...
            do
                ...
                if [[ -n $v8find ]]; then
                    ...
                    #python dostuff_chrome_arm.py  --config=client/chrome/elm-arm.config
                    python dostuff_chrome_arm.py  --config=client/chrome/elm-arm-a53.config
                    popd
