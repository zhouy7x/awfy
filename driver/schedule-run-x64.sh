        ...
        if [ -z "$list" ]; then
            ...
            do
                ...
                if [[ -n $v8find ]]; then
                    ...
                    python dostuff_x64.py --config=intel-8700k --config2=amd-3800x
