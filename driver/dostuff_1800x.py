...
parser.add_option("-d", "--device-type", dest="device_type", type="string", default="1800x",
                  help="Device type (default: 1800x)")
...
def build(device_type, config_name):
    ...
    try:
        port = int(utils.config_get_default('main', 'port', 8792))
    except:
