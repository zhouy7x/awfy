...
--
-- Host: ssgs4-test.sh.intel.com    Database: dvander
-- ------------------------------------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=79627085 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=463152 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `awfy_mode` VALUES (31,10,'IoTjs-x86','IoTjs-x86','#33FFFF',99),(28,1,'v8-temp-test','v8-temp-test','#000000',99),(26,1,'v8-turbofan-arm','v8-turbofan-arm','#DB1FA9',1),(17,0,'native','Native C++','#cccccc',1),(24,1,'v8-turbofan-x86','v8-turbofan-x86','#C96B5F',1),(22,1,'v8-turbofan-x64','v8-turbofan-x64','#A9DB1F',1),(20,1,'v8-interpreter-x64','v8-interpreter-x64','#33FF00',1),(18,11,'headless','headless','#FF0000',1),(32,11,'headless-patch','headless-compressed-pointer','#FFFF00',1),(35,12,'jsc-x64','JavaScriptCore x64','#ABCDEF',1),(34,1,'v8-turbofan-x64-patch','v8-turbofan-x64-compressed-pointer','#0000FF',1),(38,1,'v8-turbofan-arm-future','v8-turbofan-arm-future','#9AF1BD',1),(37,1,'v8-turbofan-x64-future','v8-turbofan-x64-future','#F1BD9A',1),(40,11,'headless-future','headless-future','#0088FF',1),(41,1,'v8-turbofan-x64-a-sp','v8-turbofan-x64-always-sparkplug','#AF1BD9',1),(42,1,'v8-turbofan-x64-sp','v8-turbofan-x64-sparkplug','#D9AF1B',1),(43,11,'headless-a-sp','headless-always-sparkplug','#1BD9AF',1),(44,11,'headless-sp','headless-sparkplug','#BD9AF1',1);
...
CREATE TABLE `awfy_run` (
  ...
  KEY `machine` (`machine`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=288152 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2569396 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `awfy_vendor` VALUES (1,'V8','Google','https://chromium.googlesource.com/v8/v8.git/+/','V8','http://code.google.com/p/v8/source/list?num=25&start={to}'),(2,'SpiderMonkey','Mozilla','http://hg.mozilla.org/integration/mozilla-inbound/rev/','Firefox','http://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?fromchange={from}&tochange={to}'),(10,'Iotjs','Samsung','https://github.com/Samsung/iotjs/commit/','Samsung','https://github.com/Samsung/iotjs/commit/{to}'),(11,'Chromium','Google','https://chromium.googlesource.com/chromium/src/+/','Chrome','http://code.google.com/p/chromium/source/list?num=25&start={to}'),(9,'JerryScript','Samsung','https://github.com/Samsung/jerryscript/commit/','Samsung','https://github.com/Samsung/jerryscript/commit/{to}'),(12,'JavaScriptCore','Apple','https://github.com/WebKit/webkit/commit/','Safari','https://github.com/WebKit/webkit/commit/{to}');
...
-- Dump completed on 2021-06-03 14:40:58
