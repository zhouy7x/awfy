...
) ENGINE=MyISAM AUTO_INCREMENT=70152123 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=371687 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `awfy_run` (
  ...
  KEY `machine` (`machine`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=219334 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2173859 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-24 22:02:03
