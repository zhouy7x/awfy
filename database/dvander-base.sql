...
) ENGINE=MyISAM AUTO_INCREMENT=68581630 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=355111 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `awfy_run` (
  ...
  KEY `machine` (`machine`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=202758 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2107638 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-03  9:18:46
