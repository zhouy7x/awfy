// load("../common/per_benchmark.js");

// load("crypto-libs/crypto-js/build/rollups/aes.js");
/*
CryptoJS v3.1.2
...
// load("crypto-libs/crypto-js/build/components/mode-cfb-min.js");
/*
CryptoJS v3.1.2
code.google.com/p/crypto-js
(c) 2009-2013 by Jeff Mott. All rights reserved.
...
// load("crypto-libs/crypto-js/build/components/mode-ecb.js");
/*
CryptoJS v3.1.2
code.google.com/p/crypto-js
(c) 2009-2013 by Jeff Mott. All rights reserved.
...
// load("crypto-libs/crypto-js/build/components/pad-ansix923-min.js");
/*
CryptoJS v3.1.2
code.google.com/p/crypto-js
(c) 2009-2013 by Jeff Mott. All rights reserved.
...
// load("crypto-libs/crypto-js/build/components/pad-nopadding.js");
/*
CryptoJS v3.1.2
code.google.com/p/crypto-js
(c) 2009-2013 by Jeff Mott. All rights reserved.
...
// load("crypto-libs/crypto-js/build/rollups/sha256.js");
/*
CryptoJS v3.1.2
code.google.com/p/crypto-js
(c) 2009-2013 by Jeff Mott. All rights reserved.
...
function coin_init() {
  ...
  function encrypt() {
    // print("Encrypting: " + imageDataIndex + "/" + IMAGE_DATA_SIZE);
  ...
  function decrypt() {
    // print("Decrypting: " + imageDataIndex + "/" + IMAGE_DATA_SIZE);
    if(imageDataIndex >= IMAGE_DATA_SIZE) {
  ...
  function init() {
    ...
    // img.onload = function() {
      ...
      mappedPixel.width = canvas_side;
      mappedPixel.height = canvas_side;
      mappedPixel.data = new Uint8ClampedArray(canvas_side * canvas_side * 4);      
